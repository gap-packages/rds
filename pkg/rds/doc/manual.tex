...
%%
%H $Id: manual.tex, v 0.9beta21 15/11/2006 19:33:30 gap Exp $
%%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\TitlePage{
  ...
  \centerline{Fachbereich Mathematik, TU Kaiserslautern}\medskip
  \centerline{\Mailto{roeder@mathematik.uni-kl.de}}
